...
{
    class GrilledCheeseTomato : CustomItemGroup<MyItemGroupView>
    {
        public override string UniqueNameID => "Plated Grilled Cheese with Tomato";
        ...
        public override string ColourBlindTag => "GCT";
