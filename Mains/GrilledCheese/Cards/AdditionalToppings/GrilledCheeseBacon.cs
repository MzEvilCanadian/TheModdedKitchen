...
{
    class GrilledCheeseBacon : CustomItemGroup<MyItemGroupView>
    {
        public override string UniqueNameID => "Plated Grilled Cheese with Bacon";
        ...
        public override string ColourBlindTag => "GCB";
