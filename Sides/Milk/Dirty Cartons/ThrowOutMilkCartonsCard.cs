...
namespace ModdedKitchen.Sides.Milk
{
    ...
    {
        public const RestaurantStatus RestaurantStatus = (RestaurantStatus)(-6942069);
    ...
    public class ThrowOutCupsSystem : GameSystemBase, IModSystem
    {
